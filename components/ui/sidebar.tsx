      ...
      >
        ...
        <div
          className={cn(
            ...
            'top-[var(--header-height,0px)] h-[calc(100svh-var(--header-height,0px))]',
            side === 'left'
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'min-h-[calc(100svh-var(--header-height,0px))]',
        'peer-data-[variant=inset]:min-h-[calc(100svh-var(--header-height,0px)-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
        className,
      )}
      {...props}
    />
