...
const SECTION_TEMPLATES = [
    ...
    },
    {
        id: 'url',
        title: 'URL Based',
        description: 'Curated list of external resources',
        icon: LinkIcon,
        color: 'bg-indigo-50 border-indigo-200',
        defaultTitle: 'External Resources',
        contentItems: [
            { type: 'URL', title: 'Link 1', estimatedDuration: 5 },
            { type: 'URL', title: 'Link 2', estimatedDuration: 5 },
            { type: 'URL', title: 'Link 3', estimatedDuration: 5 },
        ],
        objectives: [
            'Explore external resources',
            'Gather information from different sources',
            'Deepen knowledge with curated links'
        ]
    }
];
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {SECTION_TEMPLATES.map((template) => {
                                    ...
                                    return (
                                        <Card
                                            key={template.id}
                                            className={`cursor-pointer transition-all hover:shadow-md ${isSelected ? 'ring-2 ring-blue-500 bg-blue-50' : template.color
                                                }`}
