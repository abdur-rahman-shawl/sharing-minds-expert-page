...
function StepVisual({ visual }: { visual: string }) {
  ...
  if (visual === "ai") {
    return (
      <span className="absolute inset-2 flex items-center justify-center rounded-[24px] border border-[#367ecc]/45 bg-[#09203a] shadow-[inset_0_0_24px_rgba(24,102,190,0.2)]">
        <Cpu className="h-14 w-14 stroke-[1.15] text-[#c4d7ec]" />
  ...
  if (visual === "formats") {
    ...
    return (
      <span className="absolute inset-2 grid grid-cols-2 gap-1 overflow-hidden rounded-[18px] border border-[#367ecc]/50 bg-[#09203a] p-1">
        ...
        <UsersRound className="absolute bottom-2 left-1/2 h-6 w-6 -translate-x-1/2 rounded bg-[#071a30]/75 p-1 text-[#e1ab5b]" />
      </span>
    )
  }
  ...
  return (
    <span className="absolute inset-2 flex items-center justify-center overflow-hidden rounded-full border border-[#367ecc]/50 bg-[radial-gradient(circle_at_center,rgba(24,108,205,0.24),rgba(5,25,47,0.95)_70%)]">
      ...
      <ChartNoAxesCombined className="h-16 w-16 stroke-[1.2] text-[#267bdc]" />
    </span>
  )
}
...
export function SystemWorksSection() {
  return (
    <section
      ...
      className="relative scroll-mt-[104px] overflow-hidden bg-[#03172c] px-5 py-9 text-white sm:px-8 sm:py-11 lg:px-12"
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[1380px] gap-12 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-8">
        <div className="max-w-[280px]">
          <div className="mb-6 flex items-end gap-3">
            <span className="font-serif text-[33px] leading-none text-[#e0aa5b]">05</span>
          ...
          <h2
            ...
            className="font-serif text-[clamp(30px,2.15vw,35px)] font-normal leading-[1.04] tracking-[-0.025em] text-[#f4f1eb]"
          >
        ...
        <div className="relative">
          <div className="pointer-events-none absolute left-[5%] right-[6%] top-[63px] hidden h-px bg-[linear-gradient(90deg,transparent,#2b80df_12%,#6bb3ff_50%,#2b80df_88%,transparent)] shadow-[0_0_10px_rgba(55,145,239,0.9)] lg:block" />

          <ol className="relative grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
            {systemSteps.map(({ number, title, description, visual }, index) => (
              ...
              >
                <div className="relative mb-3 h-[126px] w-[126px]">
                  ...
                  <span className="absolute left-0 top-1/2 z-10 flex h-7 w-7 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[#377ed2] bg-[#061a31] font-serif text-[13px] text-[#c8d9ec]">
                    {number}
                  </span>
                </div>

                <h3 className="max-w-[210px] text-[13px] font-semibold leading-[1.3] text-[#f2f4f7]">
                  {title}
                </h3>
                <p className="mt-2 max-w-[210px] text-[10px] leading-[1.55] text-[#c8d1dc]">
                  {description}
                </p>
              </li>
            ))}
          ...
          <p className="mt-5 text-center text-[11px] font-medium text-[#e1aa58]">
