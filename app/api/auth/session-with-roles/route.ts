    ...
    if (isMentor) {
      const [mentor] = await db
        .select({
          ...
          industries: mentors.industries,
          normalizedIndustry: mentors.normalizedIndustry,
          expertise: mentors.expertise,
          experience: mentors.experience,
          experienceBand: mentors.experienceBand,
          employmentType: mentors.employmentType,
          about: mentors.about,
          challengeSolved: mentors.challengeSolved,
          measurableOutcomes: mentors.measurableOutcomes,
          guidanceValueProposition: mentors.guidanceValueProposition,
          credibilitySignals: mentors.credibilitySignals,
          hasPriorMentoringExperience: mentors.hasPriorMentoringExperience,
          ...
          weeklyAvailabilityBand: mentors.weeklyAvailabilityBand,
          preferredSessionMode: mentors.preferredSessionMode,
          serviceInterests: mentors.serviceInterests,
