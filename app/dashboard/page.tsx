...
export default function DashboardOverview() {
    ...
    return (
        <div className="p-6 space-y-6">
            {/* Welcome banner */}
            <div className="relative overflow-hidden rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/30 p-6">
                ...
                <div className="relative">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-semibold text-amber-400 uppercase tracking-wider">Founding Mentor</span>
                    </div>
            ...
            <div className="bg-slate-900/40 rounded-xl border border-slate-800 p-5">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-white mb-1">Platform Launch Update</h3>
...
function QuickAction({ href, icon: Icon, label, description, color }: {
    ...
    return (
        <Link
            href={href}
            className="group flex items-start gap-3 p-4 rounded-xl border border-slate-800 hover:border-slate-700 bg-slate-900/40 hover:bg-slate-800/40 transition-all duration-200"
        >
            <div className="p-2 rounded-lg bg-slate-800/80">
                <Icon className={`h-4 w-4 ${color}`} />
            </div>
            <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white group-hover:text-indigo-300 transition-colors flex items-center gap-1">
                    {label}
