...
Welcome to SharingMinds, a mentorship and collaboration platform built and operated by SoftWeb Networks (“we”, “our”, or “us”).By accessing or using 
SharingMinds (the “Platform”), you agree to comply with and be bound by these Terms of Use (“Terms”).If you do not agree to these Terms, please do not use the Platform.

1. Acceptance of Terms

By registering, accessing, or using the Platform:

You confirm you are at least 18 years old and legally capable of entering this agreement.

You acknowledge that these Terms form a binding legal contract between you and Infotech Network.

You have read and agreed to our Privacy Policy and Pricing Policy, which form part of these Terms.

SharingMinds and SoftWeb Networks reserves the right to modify or update these Terms anytime, and continued use of the Platform implies acceptance of those updates.

2. Purpose of the Platform

SharingMinds enables mentors, mentees, and professionals to connect, collaborate, and engage in structured mentorship programs, sessions, and knowledge sharing.Users agree to use the Platform responsibly, ethically, and in compliance with all applicable laws.

3. User Responsibilities

You agree not to:

Post or transmit unlawful, offensive, or misleading content.

Impersonate others or misrepresent your identity or qualifications.

Infringe on the intellectual property rights of others.

Use the Platform for spam, solicitation, or any unauthorized commercial activity.

Interfere with, hack, or disrupt the Platform’s functionality.

SharingMinds and SoftWeb Networks reserves the right to suspend or terminate accounts that violate these terms.

4. Mentor and Mentee Conduct

Mentors and mentees are expected to maintain professionalism, confidentiality, and respect in all interactions.
SharingMinds and SoftWeb Networks is not responsible for any advice, guidance, or actions resulting from mentorship sessions.

5. Intellectual Property

All text, visuals, software, and branding on SharingMinds are the exclusive property of SharinfMinds and SoftWeb Networks and protected under applicable copyright laws.Users may not reproduce or redistribute any material without prior written consent.

6. User-Generated Content

By submitting any content (e.g., profile, articles, testimonials, images), you grant Infotech Network a non-exclusive, royalty-free, worldwide license to use it for Platform operation, marketing, or community promotion purposes.

7. Disclaimers

SharingMinds is provided “as is”, without warranties of any kind, express or implied.Infotech Network does not guarantee that the Platform will be uninterrupted, error-free, or secure.

Mentorship outcomes and engagements are the responsibility of individual users.

8. Limitation of Liability

SharingMinds and Softweb Networks is not liable for any indirect, incidental, or consequential damages arising from the use of the Platform.Your sole remedy is to discontinue using the Platform.

9. Termination

Sharingminds and SoftWeb Networks may suspend or terminate access at any time if these Terms are violated or for operational or legal reasons.

10. Governing Law

These Terms shall be governed by and construed under the laws of India, with jurisdiction in Mumbai.
